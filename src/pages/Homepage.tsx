                  ...
                  <span className="flex w-full items-center justify-between">
                    <span className="flex min-w-0 items-center justify-between space-x-3">
                      <img
                        ...
                        src={user ? user.photoURL : "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3&w=256&h=256&q=80"}
                        alt=""
                      />
                      <span className="flex min-w-0 flex-1 flex-col">
                        <span className="truncate text-sm font-medium text-gray-900">{user ? user.displayName : "John Doe"} </span>
                        <span className="truncate text-sm text-gray-500">@{user ? user.displayName : "John Doe"} </span>
                      </span>
                    </span>
                    <ChevronUpDownIcon
